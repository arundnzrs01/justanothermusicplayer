...
typedef _TakeResumeDataN = Int32 Function(
    Pointer<LtSessionOpaque>, Int64, Pointer<Char>, Int32);
typedef LtTakeResumeData = int Function(
    Pointer<LtSessionOpaque>, int, Pointer<Char>, int);

typedef _AddMagnetWithResumeN = Int64 Function(Pointer<LtSessionOpaque>,
    Pointer<Utf8>, Pointer<Utf8>, Pointer<Char>, Int32, Int32);
typedef LtAddMagnetWithResume = int Function(Pointer<LtSessionOpaque>,
    Pointer<Utf8>, Pointer<Utf8>, Pointer<Char>, int, int);

typedef _SaveSessionStateN = Int32 Function(Pointer<LtSessionOpaque>, Pointer<Utf8>);
typedef LtSaveSessionState = int Function(Pointer<LtSessionOpaque>, Pointer<Utf8>);

typedef _CreateSessionFromStateN = Pointer<LtSessionOpaque> Function(
    Pointer<Utf8>, Pointer<Utf8>, Int32, Int32);
typedef LtCreateSessionFromState = Pointer<LtSessionOpaque> Function(
    Pointer<Utf8>, Pointer<Utf8>, int, int);

typedef _AbortSessionN = Void Function(Pointer<LtSessionOpaque>);
typedef LtAbortSession = void Function(Pointer<LtSessionOpaque>);
...
class TorrentBridgeBindings {
  ...
  late final LtSaveSessionState     saveSessionState;
  late final LtCreateSessionFromState createSessionFromState;
  ...
  TorrentBridgeBindings(this._lib) : hasExtendedApi = _loadExtendedApi(_lib) {
    ...
    saveSessionState    = _noopSaveSessionState;
    createSessionFromState = _noopCreateSessionFromState;
    abortSession        = _noopAbortSession;
    if (hasExtendedApi) {
      requestSaveResumeData = _lib.lookup<NativeFunction<_RequestSaveResumeDataN>>('lt_request_save_resume_data').asFunction<LtRequestSaveResumeData>();
      takeResumeData      = _lib.lookup<NativeFunction<_TakeResumeDataN>>('lt_take_resume_data').asFunction<LtTakeResumeData>();
      addMagnetWithResume = _lib.lookup<NativeFunction<_AddMagnetWithResumeN>>('lt_add_magnet_with_resume').asFunction<LtAddMagnetWithResume>();
      saveSessionState    = _lib.lookup<NativeFunction<_SaveSessionStateN>>('lt_save_session_state').asFunction<LtSaveSessionState>();
      createSessionFromState = _lib.lookup<NativeFunction<_CreateSessionFromStateN>>('lt_create_session_from_state').asFunction<LtCreateSessionFromState>();
      abortSession        = _lib.lookup<NativeFunction<_AbortSessionN>>('lt_abort_session').asFunction<LtAbortSession>();
    }
...
bool _loadExtendedApi(DynamicLibrary lib) {
  try {
    lib.lookup<NativeFunction<_RequestSaveResumeDataN>>('lt_request_save_resume_data');
    return true;
  } catch (_) {
    return false;
  }
...
int _noopTakeResumeData(Pointer<LtSessionOpaque> session, int id, Pointer<Char> out, int maxLen) => 0;

int _noopAddMagnetWithResume(Pointer<LtSessionOpaque> session, Pointer<Utf8> m, Pointer<Utf8> s, Pointer<Char> resume, int resumeLen, int streamOnly) => -1;

int _noopSaveSessionState(Pointer<LtSessionOpaque> session, Pointer<Utf8> path) => 0;

Pointer<LtSessionOpaque> _noopCreateSessionFromState(Pointer<Utf8> statePath, Pointer<Utf8> iface, int dl, int ul) => nullptr;

void _noopAbortSession(Pointer<LtSessionOpaque> session) {}
